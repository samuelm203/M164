8-- Sicherstellen das ich auf der Datenbank "Bibliothek" bin
USE Bibliothek;
...
UPDATE Kunde SET Adresse = 'Bahnhofstrasse 25', PLZ = '6210', Ort = 'Sursee', Land = 'Schweiz' WHERE Vorname = 'Max' AND Nachname = 'Verstappen' OR Vorname = 'Lewis' AND Nachname = 'Hamilton';
